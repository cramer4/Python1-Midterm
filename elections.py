...
from states import get_electorate_values_per_state, get_states
from edited_randomizing_factors import get_random_total_num_voters, get_random_number
from results_processor import process_results
from edited_randomizing_factors import get_historicly_accurate_number
...
class Elections:
    ...
    def run_vote(self, population):
        ...
        votes = get_historicly_accurate_number(population)
